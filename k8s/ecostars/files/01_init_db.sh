...
psql -h $POSTGRES_HOST -U $POSTGRES_USER -v ON_ERROR_STOP=1 -c "$DROP_TABLE_STATEMENT"
psql -h $POSTGRES_HOST -U $POSTGRES_USER -v ON_ERROR_STOP=1 -c "$DROP_PULL_HOTEL_MEASURE_TABLE_STATEMENT"
psql -h $POSTGRES_HOST -U $POSTGRES_USER -v ON_ERROR_STOP=1 -c "$DROP_PULL_HOTEL_TABLE_STATEMENT"
 
psql -h $POSTGRES_HOST -U $POSTGRES_USER -v ON_ERROR_STOP=1 -c "$CREATE_PUSH_TABLE_STATEMENT"
psql -h $POSTGRES_HOST -U $POSTGRES_USER -v ON_ERROR_STOP=1 -c "$CREATE_PULL_HOTEL_TABLE_STATEMENT"
psql -h $POSTGRES_HOST -U $POSTGRES_USER -v ON_ERROR_STOP=1 -c "$CREATE_PULL_HOTEL_MEASURE_TABLE_STATEMENT"
